...
const GifPage = () => {
  ...
  const { giphyFetch, favorites, filter, setFilter,addToFavorites } = GifContextState()
  ...
  useEffect(() => {
    ...
    const fetchGif = async () => {
      ...
      console.log(data , "Gif fetched")
      const {data: related} = await giphyFetch.related(gifId[gifId.length - 1], {
        limit: 10,
      });
      setGif(data);
